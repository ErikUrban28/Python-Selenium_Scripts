...
class TestUser:
    ...
    def test_users(self):
        ...
        rnd_helper = ''.join(random.choices(string.ascii_lowercase + string.digits + string.ascii_uppercase, k=11))
        ...
        time.sleep(2)
        self.driver.find_element(By.ID, rnd + "-edit").click()
        assert self.driver.title == "WatchFest: Edit"
        self.driver.find_element(By.NAME, "login").click()
        self.driver.find_element(By.NAME, "login").send_keys(rnd_helper)
        self.driver.find_element(By.NAME, "email").click()
        self.driver.find_element(By.NAME, "email").send_keys("abcdef@gmail.com")
        self.driver.find_element(By.NAME, "password").click()
        self.driver.find_element(By.NAME, "password").send_keys("gfdreyy")
        self.driver.find_element(By.NAME, "edit").click()
        assert self.driver.title == "WatchFest: Users"
        assert rnd_helper in self.driver.page_source
